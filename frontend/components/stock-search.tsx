  ...
  return (
    <div className={`relative z-40 ${className}`}>
      ...
      {open && results.length > 0 && (
        <div className="absolute left-0 right-0 top-full z-50 mt-2 overflow-hidden rounded-2xl border border-border/80 bg-panel/95 p-2 shadow-2xl backdrop-blur">
          <div className="search-scroll max-h-[290px] overflow-y-auto pr-1">
            ...
            <button
              ...
              className="flex w-full items-center justify-between gap-3 rounded-xl px-3 py-2 text-left hover:bg-bg"
            >
