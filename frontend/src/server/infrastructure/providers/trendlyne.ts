import { baseSymbol, getJson, getText, toFloat } from "@/server/infrastructure/http";
import type { DashboardData, DocRow, KeyRatioTrendCard, KeyRatioTrends } from "@/shared/types";
