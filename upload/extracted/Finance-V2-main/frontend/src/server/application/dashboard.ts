...
import type { AnalystConsensus } from "@/shared/contracts";
import { baseSymbol, round2, safeCall, getText, DESKTOP_UA } from "@/server/infrastructure/http";
...
} from "@/server/infrastructure/providers/fmp";
import {
  normalizeHistory,
  returnsSummary,
  returnsHeatmap,
...
} from "@/server/domain/derivations";
import { computeSmartScore, computeRiskScore } from "@/server/domain/scoring";
import { explainSmartScore, explainRiskScore, extractProfileDetails } from "@/server/ai/features";
