...
import {
  ...
  baseSymbol,
  DESKTOP_UA,
} from "@/server/infrastructure/http";
import type { Candle, RawQuote, ProviderBundle, QuarterPoint } from "@/shared/contracts";
import type { ShareholdingHolder } from "@/shared/types";
